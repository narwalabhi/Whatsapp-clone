...
import com.narwal.whatsappclone.model.ChatEvent
import com.narwal.whatsappclone.model.DateHeader
import com.narwal.whatsappclone.model.Message
import com.narwal.whatsappclone.utils.formatAsTime
        ...
        when (val item = list[position]) {
            ...
            is Message -> {
                ...
                when (getItemViewType(position)) {
                    ...
                    TEXT_MESSAGE_SENT -> {
                        if(item.liked){
                            holder.itemView.highFiveImg.visibility = View.VISIBLE
                        }else{
                            holder.itemView.highFiveImg.visibility = View.GONE
                        }
